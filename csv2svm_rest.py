...
# in age range <18 or >47.
#
# Three files are generated:
# *_rest_train.svm is the file for training.
# *_rest_ref.svm is the reference file to generate PR
# *_rest_test.svm is the file used for test
# bn82, 2012                                        
######################################################
...
try:
    ...
    out_filename = raw_name + "_rest_train" + ".svm"
    out_testref = raw_name + "_rest_ref" + ".svm"
    out_testfile = raw_name + "_rest_test" + ".svm"
...
for line in csv_input:
    ...
    for i in range(1, len(svm_line)+1):
        if i == 2:
            ...
            if (float(age) >= 18) and (float(age) <= 47):
                flag = 1
                break;
